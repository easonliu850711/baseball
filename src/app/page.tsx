  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-5xl px-4 pb-10">
        ...
        {/* Standings */}
        <section id="standings" className="mb-5 scroll-mt-20">
          <div className="rounded-2xl border border-ocean-light/10 bg-ocean-deep/50 overflow-hidden">
            <div className="border-b border-ocean-light/10 px-4 py-3 sm:px-5">
              <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <h2 className="text-sm font-bold tracking-wide text-shell-white">{leagueLabel[activeLeague]}排行榜</h2>
                </div>
              </div>
        ...
        {/* Divider */}
        <div className="my-8 h-px bg-gradient-to-r from-transparent via-ocean-light/20 to-transparent" />
